...
public class Matriz1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtDiagInv = new javax.swing.JTextField();
        ...
        jLabel7.setText("Diagonal Invertida");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtDiag, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtDiagInv, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(txtDiagInv, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnCargarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCargarActionPerformed
        ...
        calif = new int[filas][columnas];

        for (int i = 0; i < filas; i++) {
            for (int j = 0; j < columnas; j++) {
                calif[i][j] = Integer.parseInt(JOptionPane.showInputDialog("Que numero va en la fila " + i + ", columna " + j + ": "));
            }
        }
        ...
        for(int i=0;i<filas;i++){
            for(int j=0;j<columnas;j++){
                if(i+j==filas-1 && i+j==columnas-1){
                    sumaDiagInv+=calif[i][j];
                }
            }
        }
        ...
        for (int i= 0; i<filas; i++) {
            for (int j= 0; j < columnas; j++) {
               sumaMatriz+=calif[i][j];
            }
        }

        txtMayor.setText(Integer.toString(mayor));
        txtMenor.setText(Integer.toString(menor));
        txtDiag.setText(Integer.toString(sumaDiag));
        txtDiagInv.setText(Integer.toString(sumaDiagInv));
        txtSuma.setText(Integer.toString(sumaMatriz));
    }//GEN-LAST:event_btnCargarActionPerformed

    private void btnLimpiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLimpiarActionPerformed
        // TODO add your handling code here:
        txtMayor.setText(null);
        txtMenor.setText(null);
        txtColumnas.setText(null);
        txtFilas.setText(null);
        txtDiag.setText(null);
        txtDiagInv.setText(null);
    ...
    private javax.swing.JTextField txtDiagInv;
